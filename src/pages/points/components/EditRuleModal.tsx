...
import { useUpdateRule } from '../../../hooks/usePointsRules';
import { PointsRule, UpdateRuleData } from '../../../models/points-rules';
...
const EditRuleModal: React.FC<EditRuleModalProps> = ({ isOpen, onClose, rule }) => {
  ...
  const [formData, setFormData] = useState<UpdateRuleData>({
    pointsAwarded: 0,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const dataToSend: UpdateRuleData = {
      ...formData,
