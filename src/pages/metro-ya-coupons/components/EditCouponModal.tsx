...
import type { MetroYaCoupon, UpdateMetroYaCouponRequest } from '../../../models/metro-ya-coupon';

interface EditCouponModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: UpdateMetroYaCouponRequest) => void;
  coupon: MetroYaCoupon | null;
  formData: UpdateMetroYaCouponRequest;
  handleInputChange: (field: keyof UpdateMetroYaCouponRequest, value: any) => void;
      ...
      <div className="relative top-20 mx-auto p-5 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Editar Cupón</h3>
              <p className="text-sm text-gray-500">
                Modifica los detalles del cupón: {coupon.title}
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                value={formData.category || 'transport'}
            ...
            {/* Campos específicos según el tipo de beneficio original */}
            {coupon.benefitType === 'discount_percentage' && (
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
            ...
            {coupon.benefitType === 'discount_fixed' && (
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Monto de Descuento *
                </label>
            ...
            {coupon.benefitType === 'points_bonus' && (
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Puntos Bonus *
                </label>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <h4 className="text-sm font-medium text-gray-900 mb-3">Estadísticas del Cupón</h4>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              <div>
                <div className="text-gray-500">Usos Totales</div>
                <div className="font-medium text-gray-900">{coupon.stats.totalUses}</div>
              </div>
              <div>
                <div className="text-gray-500">Usuarios Activos</div>
                <div className="font-medium text-gray-900">{coupon.stats.activeUsers}</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="font-medium text-gray-900">
                  {new Date(coupon.updatedAt).toLocaleDateString('es-PE')}
                </div>
              </div>
            </div>
          </div>
